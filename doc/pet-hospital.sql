...
CREATE TABLE `register_info` (
  ...
  `clinic_id` int(10) DEFAULT NULL COMMENT '订购诊所服务ID',
  `user_id` int(10) DEFAULT NULL COMMENT '用户ID',
  `doc_id` int(10) DEFAULT NULL COMMENT '服务人员ID',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订购状态',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订购挂号表';

/*Data for the table `register_info` */

insert  into `register_info`(`id`,`clinic_id`,`user_id`,`doc_id`,`status`,`time`,`receive_id`,`receive_time`) values (2,3,2,NULL,'已接诊','2025-07-18 11:40:59',1,'2025-07-18 16:40:59'),(3,4,3,NULL,'已订购','2025-07-18 11:41:53',NULL,NULL),(4,NULL,2,3,'已完成','2025-07-18 13:57:47',3,'2025-07-18 16:13:56');
